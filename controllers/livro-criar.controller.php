...
$novoNome = md5(rand());
$extensao = pathinfo($_FILES['image']['temp_name'], PATHINFO_EXTENSION);
$imagem = "images/$dir$novoNome.$extensao";
move_uploaded_file($_FILES['image']['temp_name'], $arquivoNovo);


$database->query("insert into livros (titulo, autor, descricao, ano_de_lancamento, usuario_id, imagem)
